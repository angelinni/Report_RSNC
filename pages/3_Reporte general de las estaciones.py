...
Principal, PrincipalEp, comp = libr()
...
with st.sidebar.expander("**Sobre la app**"):
        ...
        st.write(""" 
                ...
                con la colaboración del grupo de sismología y el grupo de sistemas. Este aplicativo tiene como objetivo ayudar a los usuarios 
      ...
      """)
        st.write("**Si encuentra un error la persona que quedara acargo del código sera Angel Daniel Agudelo (adagudelo@sgc.gov.co)**")
