...
def libr():
    ...
    return mkPDF, web_inf, plot_info

mkPDF, web_inf, plot_info = libr()
...
def main():
    ...
    image = Image.open(os.path.dirname(os.path.abspath(__file__))+'/Report_Event/Simbolo_SGC_Blanco.png')
    ...
    st.sidebar.markdown(".")
    folder = os.path.dirname(os.path.abspath(__file__))+'/Report_Event/Events/'+ID_event    ###____________
    ...
    #Path
    main_path= os.path.dirname(os.path.abspath(__file__))+'/Report_Event/Events/'+ID_event
    ...
    def guardar_json(id,folder,parametro, input_ob, input_author):
        ...
        if os.path.exists(os.path.dirname(os.path.abspath(__file__))+f"/Report_Event/Events/{id}/Data/{parametro}_{id}.json") == True:
    ...
    if option == "Información General":
        ...
        if os.path.exists(os.path.dirname(os.path.abspath(__file__))+"/Report_Event/autor.json") == True:
            with open(os.path.dirname(os.path.abspath(__file__))+"/Report_Event/autor.json","r") as json_file_au: ###____________
                results_autor = json.load(json_file_au)   
            author1 = results_autor[0]["informacion_GM"]


        #Actualización de lista de autores
        if os.path.exists(os.path.dirname(os.path.abspath(__file__))+f"/Report_Event/Events/{ID_event}/Data/inf_general_{ID_event}.json") == True:
    ...
    if option == "Mecanismo focal":
        ...
        #Actualización de lista de autores
        if os.path.exists(os.path.dirname(os.path.abspath(__file__))+f"/Report_Event/Events/{ID_event}/Data/inf_mecanismofocal_{ID_event}.json") == True:
            ...
            if st.button("Guardar", help="Ingrese todos los datos y luego de Guardar, si se vuelve a guardar se reemplazarán los datos menos la de Quién revisó."):
                ...
                if len(input_fmObservations) == 0:
                    ...
                    if os.path.exists(os.path.dirname(os.path.abspath(__file__))+f"/Report_Event/Events/{ID_event}/Data/inf_mecanismofocal_{ID_event}.json") == True:
                            ...
                            st.rerun()
                    elif os.path.exists(os.path.dirname(os.path.abspath(__file__))+f"/Report_Event/Events/{ID_event}/Data/inf_mecanismofocal_f{ID_event}.json") == True:
                            ##Guardar datos de entrada en json
                            with open(folder+"/Data/"+f"inf_mecanismofocal_{ID_event}.json","r") as json_file: 
                                results = json.load(json_file) 
    ...
    if option == "Aceleraciones":
        ...
        #Actualización de lista de autores
        if os.path.exists(os.path.dirname(os.path.abspath(__file__))+f"/Report_Event/Events/{ID_event}/Data/inf_aceleracion_{ID_event}.json") == True:
    ...
    if option == "Intensidad instrumental":
        ...
        #Actualización de lista de autores
        if os.path.exists(os.path.dirname(os.path.abspath(__file__))+f"/Report_Event/Events/{ID_event}/Data/inf_instrumental_{ID_event}.json") == True:
    ...
    if option == "Intensidad percibida":
        ...
        #Actualización de lista de autores
        if os.path.exists(os.path.dirname(os.path.abspath(__file__))+f"/Report_Event/Events/{ID_event}/Data/inf_intpercibida_{ID_event}.json") == True:
    ...
    if option == "Reporte de daños":
        ...
        if os.path.exists(os.path.dirname(os.path.abspath(__file__))+f"/Report_Event/Events/{ID_event}/Data/NO_inf_dep{ID_event}.json") == True:
        ...
        #municipios
        with open(os.path.dirname(os.path.abspath(__file__))+"/Report_Event/dep_mun.json","r") as json_file:
            results = json.load(json_file)
        ...
        if st.button("Guardar municipios", help="Puede guardar el número de departamentos y municipios que desee"):
            ...
            if os.path.exists(os.path.dirname(os.path.abspath(__file__))+f"/Report_Event/Events/{ID_event}/Data/inf_dep{ID_event}.json") == True:
            ...
            if os.path.exists(os.path.dirname(os.path.abspath(__file__))+f"/Report_Event/Events/{ID_event}/Data/inf_dep_mun{ID_event}.json") == True:
        ...
        #Actualización de lista de autores
        if os.path.exists(os.path.dirname(os.path.abspath(__file__))+f"/Report_Event/Events/{ID_event}/Data/inf_repdanos_{ID_event}.json") == True:
    ...
    if option == "Efectos de la naturaleza":
        ...
        if st.button("Guardar efectos"):
            ...
            if os.path.exists(os.path.dirname(os.path.abspath(__file__))+f"/Report_Event/Events/{ID_event}/Data/inf_efectos_{ID_event}.json") == True:
...
with st.sidebar.expander("**Sobre la app**"):
        st.write("""
                **Ficha evento destacado**\n 
                """)
        st.write(""" 
                Es un Aplicativo web desarrollado por A. Agudelo y J. Soriano para generar un pdf 
                con la información general de un Evento sismico publicado en https://www.sgc.gov.co/sismos .
                
      """)

        st.write("**Si encuentra un error escribir al correo adagudelo@sgc.gov.co o jsoriano@sgc.gov.co**")
